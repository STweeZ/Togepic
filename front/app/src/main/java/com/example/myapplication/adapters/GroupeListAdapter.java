...
public class GroupeListAdapter extends ArrayAdapter {

    public GroupeListAdapter(Context context, List invitations) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView groupName = convertView.findViewById(R.id.name);
        groupName.setText(invitation.getName());
        ImageView groupPicture = convertView.findViewById(R.id.picture);
